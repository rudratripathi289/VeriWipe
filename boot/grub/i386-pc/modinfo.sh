...
grub_target_cppflags='-Wno-unused-but-set-variable -Wall -W  -DGRUB_MACHINE_PCBIOS=1 -DGRUB_MACHINE=I386_PC -m32 -nostdinc -isystem /usr/lib/gcc/x86_64-linux-gnu/14/include -I$(top_srcdir)/include -I$(top_builddir)/include'
...
grub_version="2.12"
grub_package="grub"
grub_package_string="GRUB 2.12-9+kali1"
grub_package_version="2.12-9+kali1"
